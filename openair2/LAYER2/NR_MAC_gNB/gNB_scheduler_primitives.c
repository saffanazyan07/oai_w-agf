...
static void determine_aggregation_level_search_order(int agg_level_search_order[NUM_PDCCH_AGGREGATION_LEVELS],
                  ...
                  float pdcch_cl_adjust)
{
  ...
  int agg_level_search_order[NUM_PDCCH_AGGREGATION_LEVELS];
  determine_aggregation_level_search_order(agg_level_search_order, pdcch_cl_adjust);

  for (int i = 0; i < NUM_PDCCH_AGGREGATION_LEVELS; i++) {
                                                     ...
                                                     float pdcch_cl_adjust)
{
  ...
  for (int i = desired_agg_level_index; i < NUM_PDCCH_AGGREGATION_LEVELS; i++) {
...
/// @param feedback_detected Whether feedback (PUSCH or HARQ) was detected
void nr_mac_update_pdcch_closed_loop_adjust(NR_UE_sched_ctrl_t *sched_ctrl, bool feedback_detected)
{
