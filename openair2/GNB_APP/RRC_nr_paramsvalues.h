...
#define GNB_CONFIG_STRING_PATTERN2                                       "pattern2Present"
...
#define GNB_CONFIG_STRING_DLULTRANSMISSIONPERIODICITY2_IDX 0

#define SCC_PATTERN2_PARAMS_DESC(scc) { \
{GNB_CONFIG_STRING_DLULTRANSMISSIONPERIODICITY2,NULL,0,.i64ptr=&pattern2.dl_UL_TransmissionPeriodicity,.defintval=-1,TYPE_INT64,0},\
