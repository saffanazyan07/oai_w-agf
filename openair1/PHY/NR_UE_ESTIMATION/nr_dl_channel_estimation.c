                              ...
                              NR_UE_DLSCH_t dlsch[2])
{
  ...
  for (int aarx=0; aarx<frame_parms->nb_antennas_rx; aarx++) {
        ...
        *ptrsSymbIdx = symbol;
        ...
        nr_ptrs_cpe_estimation(*K_ptrs,
                               ...
                               *nb_rb,
                               ...
                               (int16_t *)(rxdataF_comp[0] + symbol * rx_size_symbol),
                               gold,
    ...
    if(symbol == (symbInSlot -1)) {
      ...
      LOG_M("rxdataF_bf_ptrs_comp.m", "bf_ptrs_cmp", rxdataF_comp[0] + (*startSymbIndex) * rx_size_symbol, rx_size_symbol * (*nbSymb), 1, 1);
#endif
      /*------------------------------------------------------------------------------------------------------- */
...
#endif
          rotate_cpx_vector((c16_t *)&rxdataF_comp[0][i * rx_size_symbol],
                            &phase_per_symbol[i],
                            (c16_t *)&rxdataF_comp[0][i * rx_size_symbol],
